// Generated by gencpp from file gps_msgs/gpsUtm.msg
// DO NOT EDIT!


#ifndef GPS_MSGS_MESSAGE_GPSUTM_H
#define GPS_MSGS_MESSAGE_GPSUTM_H
...
struct gpsUtm_
{
  ...
  typedef boost::shared_ptr< ::gps_msgs::gpsUtm_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::gps_msgs::gpsUtm_<ContainerAllocator> const> ConstPtr;

}; // struct gpsUtm_

typedef ::gps_msgs::gpsUtm_<std::allocator<void> > gpsUtm;

typedef boost::shared_ptr< ::gps_msgs::gpsUtm > gpsUtmPtr;
typedef boost::shared_ptr< ::gps_msgs::gpsUtm const> gpsUtmConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::gps_msgs::gpsUtm_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::gps_msgs::gpsUtm_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::gps_msgs::gpsUtm_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::gps_msgs::gpsUtm_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::gps_msgs::gpsUtm_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::gps_msgs::gpsUtm_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::gps_msgs::gpsUtm_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::gps_msgs::gpsUtm_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::gps_msgs::gpsUtm_<ContainerAllocator> >
{
  ...
  static const char* value(const ::gps_msgs::gpsUtm_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xdd6300f2dc181584ULL;
  static const uint64_t static_value2 = 0xe828bfc2114a931dULL;
};

template<class ContainerAllocator>
struct DataType< ::gps_msgs::gpsUtm_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::gps_msgs::gpsUtm_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::gps_msgs::gpsUtm_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::gps_msgs::gpsUtm_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::gps_msgs::gpsUtm_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
...
#endif // GPS_MSGS_MESSAGE_GPSUTM_H
