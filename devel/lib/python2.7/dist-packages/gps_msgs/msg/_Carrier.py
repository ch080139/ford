...
float32[33] phase_std"""
  ...
  def serialize(self, buff):
    ...
    """
    try:
      buff.write(_get_struct_33d().pack(*self.doppler))
      buff.write(_get_struct_33d().pack(*self.noise))
      buff.write(_get_struct_33d().pack(*self.phase))
      buff.write(_get_struct_33f().pack(*self.phase_std))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.doppler = _get_struct_33d().unpack(str[start:end])
      start = end
      end += 264
      self.noise = _get_struct_33d().unpack(str[start:end])
      start = end
      end += 264
      self.phase = _get_struct_33d().unpack(str[start:end])
      start = end
      end += 132
      self.phase_std = _get_struct_33f().unpack(str[start:end])
      return self
