...
float64 u"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_get_struct_3dB6d().pack(_x.gps_time0, _x.gps_time1, _x.dt, _x.status, _x.xyz.x, _x.xyz.y, _x.xyz.z, _x.enu.e, _x.enu.n, _x.enu.u))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.gps_time0, _x.gps_time1, _x.dt, _x.status, _x.xyz.x, _x.xyz.y, _x.xyz.z, _x.enu.e, _x.enu.n, _x.enu.u,) = _get_struct_3dB6d().unpack(str[start:end])
      self.stamp.canon()
      return self
