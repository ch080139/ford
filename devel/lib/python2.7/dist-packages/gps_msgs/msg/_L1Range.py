...
"""autogenerated by genpy from gps_msgs/L1Range.msg. Do not edit."""
import sys
...
class L1Range(genpy.Message):
  _md5sum = "48af8bb7d8f541371fb9d7dd349d5bca"
  _type = "gps_msgs/L1Range"
...
float32[33] phase_std"""
  __slots__ = ['header','seq','stamp','frame_id','gps_id','gps_time','L1','lat','lon','alt','lat_cov','lon_cov','alt_cov']
  _slot_types = ['std_msgs/Header','uint32','time','string','string','int64','gps_msgs/GpsRange','float64','float64','float64','float64','float64','float64']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,seq,stamp,frame_id,gps_id,gps_time,L1,lat,lon,alt,lat_cov,lon_cov,alt_cov
    ...
    """
    if args or kwds:
      super(L1Range, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_get_struct_qB().pack(_x.gps_time, _x.L1.obs))
      _x = self.L1.prn
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.gps_time, _x.L1.obs,) = _get_struct_qB().unpack(str[start:end])
      start = end
      end += 33
