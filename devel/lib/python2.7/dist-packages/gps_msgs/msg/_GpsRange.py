...
float32[33] phase_std"""
  ...
  def serialize(self, buff):
    ...
    """
    try:
      buff.write(_get_struct_B().pack(self.obs))
      _x = self.prn
      ...
      buff.write(_get_struct_33d().pack(*self.psr))
      buff.write(_get_struct_33f().pack(*self.psr_std))
      buff.write(_get_struct_33d().pack(*self.carrier.doppler))
      buff.write(_get_struct_33d().pack(*self.carrier.noise))
      buff.write(_get_struct_33d().pack(*self.carrier.phase))
      buff.write(_get_struct_33f().pack(*self.carrier.phase_std))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.obs,) = _get_struct_B().unpack(str[start:end])
      start = end
      end += 33
      self.prn = str[start:end]
      start = end
      end += 264
      self.psr = _get_struct_33d().unpack(str[start:end])
      start = end
      end += 132
      self.psr_std = _get_struct_33f().unpack(str[start:end])
      start = end
      end += 264
      self.carrier.doppler = _get_struct_33d().unpack(str[start:end])
      start = end
      end += 264
      self.carrier.noise = _get_struct_33d().unpack(str[start:end])
      start = end
      end += 264
      self.carrier.phase = _get_struct_33d().unpack(str[start:end])
      start = end
      end += 132
      self.carrier.phase_std = _get_struct_33f().unpack(str[start:end])
      return self
