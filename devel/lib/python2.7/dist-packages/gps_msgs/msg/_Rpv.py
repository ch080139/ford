...
float64 u"""
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.gps_time, _x.status, _x.ratio, _x.input_obs, _x.non_fault_obs, _x.amb_obs, _x.sp.xyz.x, _x.sp.xyz.y, _x.sp.xyz.z, _x.sp.enu.e, _x.sp.enu.n, _x.sp.enu.u, _x.sp.magnitude, _x.sp.horizontal_magnitude, _x.lp.xyz.x, _x.lp.xyz.y, _x.lp.xyz.z, _x.lp.enu.e, _x.lp.enu.n, _x.lp.enu.u, _x.lp.magnitude, _x.lp.horizontal_magnitude, _x.hp.xyz.x, _x.hp.xyz.y, _x.hp.xyz.z, _x.hp.enu.e, _x.hp.enu.n, _x.hp.enu.u, _x.hp.magnitude, _x.hp.horizontal_magnitude, _x.base_prn_float, _x.base_prn_fixed,) = _get_struct_qbd3i24d2i().unpack(str[start:end])
      self.stamp.canon()
      return self
...
def _get_struct_3I():
    ...
    return _struct_3I
_struct_qbd3i24d2i = None
def _get_struct_qbd3i24d2i():
    global _struct_qbd3i24d2i
    if _struct_qbd3i24d2i is None:
        _struct_qbd3i24d2i = struct.Struct("<qbd3i24d2i")
    return _struct_qbd3i24d2i
