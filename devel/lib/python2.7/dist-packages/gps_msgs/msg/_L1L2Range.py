...
float32[33] phase_std"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_get_struct_qiB().pack(_x.gps_time, _x.num_obs, _x.L1.obs))
      _x = self.L1.prn
      # - if encoded as a list instead, serialize as bytes instead of string
      if type(_x) in [list, tuple]:
        buff.write(_get_struct_33B().pack(*_x))
      else:
        buff.write(_get_struct_33s().pack(_x))
      buff.write(_get_struct_33d().pack(*self.L1.psr))
      buff.write(_get_struct_33f().pack(*self.L1.psr_std))
      buff.write(_get_struct_33d().pack(*self.L1.carrier.doppler))
      buff.write(_get_struct_33d().pack(*self.L1.carrier.noise))
      buff.write(_get_struct_33d().pack(*self.L1.carrier.phase))
      buff.write(_get_struct_33f().pack(*self.L1.carrier.phase_std))
      buff.write(_get_struct_B().pack(self.L2.obs))
      _x = self.L2.prn
      # - if encoded as a list instead, serialize as bytes instead of string
      if type(_x) in [list, tuple]:
        buff.write(_get_struct_33B().pack(*_x))
        ...
        buff.write(_get_struct_33s().pack(_x))
      buff.write(_get_struct_33d().pack(*self.L2.psr))
      buff.write(_get_struct_33f().pack(*self.L2.psr_std))
      buff.write(_get_struct_33d().pack(*self.L2.carrier.doppler))
      buff.write(_get_struct_33d().pack(*self.L2.carrier.noise))
      buff.write(_get_struct_33d().pack(*self.L2.carrier.phase))
      buff.write(_get_struct_33f().pack(*self.L2.carrier.phase_std))
      _x = self
      buff.write(_get_struct_6d().pack(_x.lat, _x.lon, _x.alt, _x.lat_cov, _x.lon_cov, _x.alt_cov))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.gps_time, _x.num_obs, _x.L1.obs,) = _get_struct_qiB().unpack(str[start:end])
      start = end
      end += 33
      self.L1.prn = str[start:end]
      start = end
      end += 264
      self.L1.psr = _get_struct_33d().unpack(str[start:end])
      start = end
      end += 132
      self.L1.psr_std = _get_struct_33f().unpack(str[start:end])
      start = end
      end += 264
      self.L1.carrier.doppler = _get_struct_33d().unpack(str[start:end])
      start = end
      end += 264
      self.L1.carrier.noise = _get_struct_33d().unpack(str[start:end])
      start = end
      end += 264
      self.L1.carrier.phase = _get_struct_33d().unpack(str[start:end])
      start = end
      end += 132
      self.L1.carrier.phase_std = _get_struct_33f().unpack(str[start:end])
      start = end
      end += 1
      (self.L2.obs,) = _get_struct_B().unpack(str[start:end])
      start = end
      end += 33
      self.L2.prn = str[start:end]
      start = end
      end += 264
      self.L2.psr = _get_struct_33d().unpack(str[start:end])
      start = end
      end += 132
      self.L2.psr_std = _get_struct_33f().unpack(str[start:end])
      start = end
      end += 264
      self.L2.carrier.doppler = _get_struct_33d().unpack(str[start:end])
      start = end
      end += 264
      self.L2.carrier.noise = _get_struct_33d().unpack(str[start:end])
      start = end
      end += 264
      self.L2.carrier.phase = _get_struct_33d().unpack(str[start:end])
      start = end
      end += 132
      self.L2.carrier.phase_std = _get_struct_33f().unpack(str[start:end])
      _x = self
      start = end
      end += 48
      (_x.lat, _x.lon, _x.alt, _x.lat_cov, _x.lon_cov, _x.alt_cov,) = _get_struct_6d().unpack(str[start:end])
      self.stamp.canon()
      return self
