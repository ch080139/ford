...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_get_struct_db().pack(_x.gps_time, _x.obs))
      buff.write(_get_struct_33b().pack(*self.prn))
      buff.write(_get_struct_33b().pack(*self.health))
      buff.write(_get_struct_33d().pack(*self.semimajor_axis))
      buff.write(_get_struct_33d().pack(*self.mean_anomaly))
      buff.write(_get_struct_33d().pack(*self.eccentricity))
      buff.write(_get_struct_33d().pack(*self.perigee_arg))
      buff.write(_get_struct_33d().pack(*self.cos_latitude))
      buff.write(_get_struct_33d().pack(*self.sin_latitude))
      buff.write(_get_struct_33d().pack(*self.cos_orbit_radius))
      buff.write(_get_struct_33d().pack(*self.sin_orbit_radius))
      buff.write(_get_struct_33d().pack(*self.cos_inclination))
      buff.write(_get_struct_33d().pack(*self.sin_inclination))
      buff.write(_get_struct_33d().pack(*self.inclination_angle))
      buff.write(_get_struct_33d().pack(*self.right_ascension))
      buff.write(_get_struct_33d().pack(*self.mean_motion_diff))
      buff.write(_get_struct_33d().pack(*self.inclination_rate))
      buff.write(_get_struct_33d().pack(*self.ascension_rate))
      buff.write(_get_struct_33d().pack(*self.time_of_week))
      buff.write(_get_struct_33d().pack(*self.reference_time))
      buff.write(_get_struct_33d().pack(*self.clock_correction))
      buff.write(_get_struct_33d().pack(*self.group_delay))
      buff.write(_get_struct_33d().pack(*self.clock_aging_1))
      buff.write(_get_struct_33d().pack(*self.clock_aging_2))
      buff.write(_get_struct_33d().pack(*self.clock_aging_3))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.gps_time, _x.obs,) = _get_struct_db().unpack(str[start:end])
      start = end
      end += 33
      self.prn = _get_struct_33b().unpack(str[start:end])
      start = end
      end += 33
      self.health = _get_struct_33b().unpack(str[start:end])
      start = end
      end += 264
      self.semimajor_axis = _get_struct_33d().unpack(str[start:end])
      start = end
      end += 264
      self.mean_anomaly = _get_struct_33d().unpack(str[start:end])
      start = end
      end += 264
      self.eccentricity = _get_struct_33d().unpack(str[start:end])
      start = end
      end += 264
      self.perigee_arg = _get_struct_33d().unpack(str[start:end])
      start = end
      end += 264
      self.cos_latitude = _get_struct_33d().unpack(str[start:end])
      start = end
      end += 264
      self.sin_latitude = _get_struct_33d().unpack(str[start:end])
      start = end
      end += 264
      self.cos_orbit_radius = _get_struct_33d().unpack(str[start:end])
      start = end
      end += 264
      self.sin_orbit_radius = _get_struct_33d().unpack(str[start:end])
      start = end
      end += 264
      self.cos_inclination = _get_struct_33d().unpack(str[start:end])
      start = end
      end += 264
      self.sin_inclination = _get_struct_33d().unpack(str[start:end])
      start = end
      end += 264
      self.inclination_angle = _get_struct_33d().unpack(str[start:end])
      start = end
      end += 264
      self.right_ascension = _get_struct_33d().unpack(str[start:end])
      start = end
      end += 264
      self.mean_motion_diff = _get_struct_33d().unpack(str[start:end])
      start = end
      end += 264
      self.inclination_rate = _get_struct_33d().unpack(str[start:end])
      start = end
      end += 264
      self.ascension_rate = _get_struct_33d().unpack(str[start:end])
      start = end
      end += 264
      self.time_of_week = _get_struct_33d().unpack(str[start:end])
      start = end
      end += 264
      self.reference_time = _get_struct_33d().unpack(str[start:end])
      start = end
      end += 264
      self.clock_correction = _get_struct_33d().unpack(str[start:end])
      start = end
      end += 264
      self.group_delay = _get_struct_33d().unpack(str[start:end])
      start = end
      end += 264
      self.clock_aging_1 = _get_struct_33d().unpack(str[start:end])
      start = end
      end += 264
      self.clock_aging_2 = _get_struct_33d().unpack(str[start:end])
      start = end
      end += 264
      self.clock_aging_3 = _get_struct_33d().unpack(str[start:end])
      self.stamp.canon()
      return self
