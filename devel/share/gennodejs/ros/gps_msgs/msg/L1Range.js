...
class L1Range {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type L1Range
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type L1Range
    let len;
    let data = new L1Range(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new L1Range(null);
