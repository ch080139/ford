...
(cl:defmethod cl:initialize-instance :after ((m <Utm>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Utm)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name gps_msgs-msg:<Utm> is deprecated: use gps_msgs-msg:Utm instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <Utm>))
...
(cl:defmethod yaw-val ((m <Utm>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gps_msgs-msg:yaw-val is deprecated.  Use gps_msgs-msg:yaw instead.")
  (yaw m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Utm>)))
  ...
  "882a59d5e902f1dbf03c87bca4095138")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Utm)))
  "Returns md5sum for a message object of type 'Utm"
  "882a59d5e902f1dbf03c87bca4095138")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Utm>)))
  ...
  (cl:format cl:nil "~%Header header~%~%float64 x~%float64 y~%float64 z~%~%float64 yaw~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Utm)))
  "Returns full string definition for message of type 'Utm"
  (cl:format cl:nil "~%Header header~%~%float64 x~%float64 y~%float64 z~%~%float64 yaw~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
